...
./configure --disable-shared --enable-static --with-zlib --disable-dict --disable-pop3 --disable-imap --disable-smb --disable-smtp --disable-gopher --disable-mqtt --disable-manual --disable-ldap --disable-ldaps --disable-rtsp  --disable-tftp --disable-file --disable-ftp --disable-telnet  --disable-docs --enable-websockets --without-zstd --with-ssl=/home/jecky/openssl --prefix=${BUILD_PATH}
make
make install
